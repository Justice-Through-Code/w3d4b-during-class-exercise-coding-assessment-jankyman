...
def main():
    ...
    print('Welcome to geometric shape area calculator! ')
    ...
    choice = '1', '2', '3'
    print(input(f'please choose a shape from the selection{choice}'))
    ...
    if choice == 1:  #DO NOT REMOVE THE 'IF'
        ...
        radius = input(f'what is the radius of the cicrcle?')
        ...
        length = input(f'what is the length and width of the rectangle? ')
        ...
        base = input(f'what is the base of the triangle?')
    ...
    # read the directions over and over again
    # remeber my notes and take my time 
    # i ran my unittest
    # 
    # 
    # 
